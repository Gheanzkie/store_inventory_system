                            ...
                            <?php if (!empty($logs)): ?>
                                <div class="timeline">
                                    ...
                                    ?>
                                        ...
                                        <?= ($log['identifier'] ?? '') == 'LOGIN' ? 'text-success' : (($log['identifier'] ?? '') == 'LOGOUT' ? 'text-warning' : (($log['identifier'] ?? '') == 'DELETE' ? 'text-danger' : (($log['identifier'] ?? '') == 'ADD' ? 'text-success' : (($log['identifier'] ?? '') == 'UPDATE' ? 'text-warning' : 'text-info')))) ?>">
                                            </i>
