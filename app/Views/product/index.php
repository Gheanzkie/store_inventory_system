                        ...
                        <div class="card-header bg-white border-0 pt-3 pb-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="badge badge-light text-muted ml-3" id="productCount">
...
.custom-select:focus, .form-control:focus { border-color: #9ca3af; box-shadow: 0 0 0 0.2rem rgba(107, 114, 128, 0.15); }
...
.dataTables_wrapper .dataTables_length select, .dataTables_wrapper .dataTables_filter input { border: 1px solid #e5e7eb; border-radius: 6px; padding: 4px 8px; }
.page-item.active .page-link { background-color: #6b7280; border-color: #6b7280; }
.page-link { color: #4b5563; }
.page-link:hover { color: #374151; }
